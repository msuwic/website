...
<body>
    ...
    <div class="wicbits-page">
        <div class="section">
            ...
            <h2>WicBits 2020-2021</h2>
            <div class="wicbits-section">
                <?php
                $directory = "";
                $root = "../../wicbits/2020-2021";
                ...
                foreach($files as $file)
                {
                    ...
                    else if (substr($file, 0, 2) == "06")
                    {
                        array_push($june, $file);
                    }
                ...
                echo "<h3 class=\"wicbits-month\">September 2020</h3>";
                foreach ($september as $file)
                {
                    echo "<a class=\"wicbits-file\" href=\"$root/$file\">$file</a>";
                }

                echo "<h3 class=\"wicbits-month\">October 2020</h3>";
                foreach ($october as $file)
                {
                    echo "<a class=\"wicbits-file\" href=\"$root/$file\">$file</a>";
                }

                echo "<h3 class=\"wicbits-month\">November 2020</h3>";
                foreach ($november as $file)
                {
                    echo "<a class=\"wicbits-file\" href=\"$root/$file\">$file</a>";
                }

                echo "<h3 class=\"wicbits-month\">December 2020</h3>";
                foreach ($december as $file)
                {
                    echo "<a class=\"wicbits-file\" href=\"$root/$file\">$file</a>";
                }

                echo "<h3 class=\"wicbits-month\">January 2021</h3>";
                foreach ($january as $file)
                {
                    echo "<a class=\"wicbits-file\" href=\"$root/$file\">$file</a>";
                }

                echo "<h3 class=\"wicbits-month\">February 2021</h3>";
                foreach ($february as $file)
                {
                    echo "<a class=\"wicbits-file\" href=\"$root/$file\">$file</a>";
                }

                echo "<h3 class=\"wicbits-month\">March 2021</h3>";
                foreach ($march as $file)
                {
                    echo "<a class=\"wicbits-file\" href=\"$root/$file\">$file</a>";
                }
                echo "<h3 class=\"wicbits-month\">June 2021</h3>";
                foreach ($june as $file)
                {
                    echo "<a class=\"wicbits-file\" href=\"$root/$file\">$file</a>";
                }
                ?>
