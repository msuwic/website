...
<body>
    ...
    <div class="wicbits-page">
        <div class="section">
            ...
            <h2>WicBits 2019-2020</h2>
            <div class="wicbits-section">
                <?php
                $directory = "";
                $root = "../../wicbits/2019-2020";
                ...
                echo "<h3 class=\"wicbits-month\">September 2019</h3>";
                foreach ($september as $file)
                {
                    echo "<a class=\"wicbits-file\" href=\"$root/$file\">$file</a>";
                }

                echo "<h3 class=\"wicbits-month\">October 2019</h3>";
                foreach ($october as $file)
                {
                    echo "<a class=\"wicbits-file\" href=\"$root/$file\">$file</a>";
                }

                echo "<h3 class=\"wicbits-month\">November 2019</h3>";
                foreach ($november as $file)
                {
                    echo "<a class=\"wicbits-file\" href=\"$root/$file\">$file</a>";
                }

                echo "<h3 class=\"wicbits-month\">December 2019</h3>";
                foreach ($december as $file)
                {
                    echo "<a class=\"wicbits-file\" href=\"$root/$file\">$file</a>";
                }

                echo "<h3 class=\"wicbits-month\">January 2020</h3>";
                foreach ($january as $file)
                {
                    echo "<a class=\"wicbits-file\" href=\"$root/$file\">$file</a>";
                }

                echo "<h3 class=\"wicbits-month\">February 2020</h3>";
                foreach ($february as $file)
                {
                    echo "<a class=\"wicbits-file\" href=\"$root/$file\">$file</a>";
                }

                echo "<h3 class=\"wicbits-month\">March 2020</h3>";
                foreach ($march as $file)
                {
                    echo "<a class=\"wicbits-file\" href=\"$root/$file\">$file</a>";
                }

                echo "<h3 class=\"wicbits-month\">April 2020</h3>";
                foreach ($april as $file)
                {
                    echo "<a class=\"wicbits-file\" href=\"$root/$file\">$file</a>";
                }
                echo "<h3 class=\"wicbits-month\">May 2020</h3>";
                foreach ($may as $file)
                {
                    echo "<a class=\"wicbits-file\" href=\"$root/$file\">$file</a>";
                }
